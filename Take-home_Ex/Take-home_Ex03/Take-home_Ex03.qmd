...
plt1 <- ggplot(pivot_season, aes(x = Year)) +
  ...
  geom_point(aes(y = `Dry Season`, fill = "Dry Season", text = hover_text), size = 4, pch = 21, color = "white", stroke = 1) +
  geom_point(aes(y = `Wet Season`, fill = "Wet Season", text = hover_text), size = 4, pch = 21, color = "white", stroke = 1) +
...
patchwork <- (plt1_stat | plt3) / (plt2 | plt4)
patchwork + 
