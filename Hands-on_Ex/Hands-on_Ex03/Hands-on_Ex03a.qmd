...
-   theory: a summary of [*R for Visual Analytics - Chap 3*](https://r4va.netlify.app/chap03)
...
In this exercise, [**ggiraph**](https://davidgohel.github.io/ggiraph/)**, [plotly](https://plotly.com/r/)**, [**DT**](https://rstudio.github.io/DT/), [**tidyverse**](https://www.tidyverse.org/), [**patchwork**](https://patchwork.data-imaginist.com/) packages are used. A summary of the new packages introduced can be found at the section [below](#summary).
...
| library | [**ggiraph**](https://davidgohel.github.io/ggiraph/) | [**plotly**](https://plotly.com/r/) | [**DT**](https://rstudio.github.io/DT/) |
|---------|------------------------------------------------------|-------------------------------------|-----------------------------------------|
|         |                                                      |                                     |                                         |
|         |                                                      |                                     |                                         |
|         |                                                      |                                     |                                         |
...
[ggiraph](https://davidgohel.github.io/ggiraph/) is an htmlwidget and a ggplot2 extension which allows interaction made with [**ggplot geometries**](https://davidgohel.github.io/ggiraph/reference/#section-interactive-geometries)
...
-   an interactive version of ggplot2 geom (i.e. [`geom_dotplot_interactive()`](https://davidgohel.github.io/ggiraph/reference/geom_dotplot_interactive.html)) will be used to create the basic graph.

-   [`girafe()`](https://davidgohel.github.io/ggiraph/reference/girafe.html) will be used to generate an svg object to be displayed on an html page.
