...
-   theory: a summary of *R for Visual Analytics*
    ...
    -   [Modelling, Visualising and Analysing Network Data with R](https://r4va.netlify.app/chap27)

# A Quick Summary

## Data Preperation

1.  Data Required: edge data + node data
2.  Aggregation by node
3.  network object
...
+==================================================+===========================+=================================================================================================+==========================================================================================================+
| [**ggraph**](https://ggraph.data-imaginist.com/) | Basic                     | ggraph() + geom_edge_link() + geom_node_point()                                                 |                                                                                                          |
+--------------------------------------------------+---------------------------+-------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------+
|                                                  | Change Theme              | \+ theme_graph()                                                                                |                                                                                                          |
+--------------------------------------------------+---------------------------+-------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------+
|                                                  | Change color              | -   geom_edge_link(aes(colour = 'grey50'))                                                      | -   `geom_edge_link` & `geom_node_point` : aes(color = )                                                 |
|                                                  |                           |                                                                                                 |                                                                                                          |
|                                                  |                           | -   theme_graph(background = 'grey10', text_colour = 'white')                                   | -   `them_graph`: background, text_color                                                                 |
+--------------------------------------------------+---------------------------+-------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------+
|                                                  | Change Layout             | ggraph(GAStech_graph, layout = "fr")                                                            | -   `ggraph`: layout                                                                                     |
|                                                  |                           |                                                                                                 |                                                                                                          |
|                                                  |                           |                                                                                                 | -   star, circle, nicely (default), dh, gem, graphopt, grid, mds, spahere, randomly, fr, kk, drl and lgl |
+--------------------------------------------------+---------------------------+-------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------+
|                                                  | Modify Node               | geom_node_point(aes(colour = Department, size = 3))                                             | -   [geom_node_point()](https://ggraph.data-imaginist.com/reference/geom_node_point.html#arguments-1)    |
|                                                  |                           |                                                                                                 |                                                                                                          |
|                                                  |                           |                                                                                                 | -   alpha, colour, fill, shape, size, stroke, filter                                                     |
+--------------------------------------------------+---------------------------+-------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------+
|                                                  | Modify Edge               | geom_edge_link(aes(width=Weight), alpha=0.2) + scale_edge_width(range = c(0.1, 5))              | -   [geom_edge_link()](https://ggraph.data-imaginist.com/reference/geom_edge_link.html)                  |
|                                                  |                           |                                                                                                 |                                                                                                          |
|                                                  |                           |                                                                                                 | -   edge_colour, edge_width, edge_linetype, edge_alpha, filter                                           |
+--------------------------------------------------+---------------------------+-------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------+
|                                                  | Facet graphs              | g \<- Basic plot                                                                                | [facet_edges()](https://ggraph.data-imaginist.com/reference/facet_edges.html)                            |
|                                                  |                           |                                                                                                 |                                                                                                          |
|                                                  |                           | g + [*facet_edges()*](https://ggraph.data-imaginist.com/reference/facet_edges.html) (\~Weekday) |                                                                                                          |
+--------------------------------------------------+---------------------------+-------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------+
|                                                  | Facet graphs Change Theme | g \<- Basic plot + theme(legend.position = 'bottom')                                            | `theme()`                                                                                                |
|                                                  |                           |                                                                                                 |                                                                                                          |
|                                                  |                           | g + [*facet_edges()*](https://ggraph.data-imaginist.com/reference/facet_edges.html) (\~Weekday) |                                                                                                          |
+--------------------------------------------------+---------------------------+-------------------------------------------------------------------------------------------------+----------------------------------------------------------------------------------------------------------+
...
+=============================================================+===============+====================================================================================================+==============================+
| [visNetwork()](http://datastorm-open.github.io/visNetwork/) | Basic         | visNetwork(node, edge)                                                                             |                              |
+-------------------------------------------------------------+---------------+----------------------------------------------------------------------------------------------------+------------------------------+
|                                                             | Change layout | visNetwork() %\>% visIgraphLayout(layout = "layout_with_fr")                                       | -   visIgraphLayout(layout)  |
|                                                             |               |                                                                                                    |                              |
|                                                             |               |                                                                                                    | -   layout: "layout_with_fr" |
+-------------------------------------------------------------+---------------+----------------------------------------------------------------------------------------------------+------------------------------+
|                                                             | Color by Node | nodes %\>% rename(group)                                                                           |                              |
|                                                             |               |                                                                                                    |                              |
|                                                             |               | visNetwork(node, edge)                                                                             |                              |
+-------------------------------------------------------------+---------------+----------------------------------------------------------------------------------------------------+------------------------------+
|                                                             | Edge          | visNetwork(node, edge) + visEdges(arrows = "to", smooth = list(enabled = TRUE, type = "curvedCW")) | -   visEdges()               |
|                                                             |               |                                                                                                    |                              |
|                                                             |               |                                                                                                    | -   arrows, smooth, type     |
+-------------------------------------------------------------+---------------+----------------------------------------------------------------------------------------------------+------------------------------+
...
[*theme_graph()*](https://ggraph.data-imaginist.com/reference/theme_graph.html) remove the x and y axes
...
the code chunk below, Fruchterman and Reingold layout is used.
