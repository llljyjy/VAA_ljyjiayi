...
+------------------+-------------+--------------------------------+-------------+
| package          | **treemap** | **treemapify**                 | **d3treeR** |
+------------------+-------------+--------------------------------+-------------+
| func             | `treemap()` | `geom_treemap()`               | `d3tree()`  |
+------------------+-------------+--------------------------------+-------------+
| common arguement | `index`     | `scale_fill_gradient`          | `treemap()` |
|                  |             |                                |             |
|                  | `vSize`     | `aes(area, fill, subgroup)`    | `d3tree()`  |
|                  |             |                                |             |
|                  | `vColor`    | `geom_treemap_subgroup_border` |             |
|                  |             |                                |             |
|                  | `palette`   |                                |             |
|                  |             |                                |             |
|                  | `type`      |                                |             |
