...
-   theory: a summary of *R for Visual Analytics*
    ...
    -   [Information Dashboard Design: R methods](https://r4va.netlify.app/chap31)
...
a personal database in Microsoft Access mdb format called *Coffee Chain* will be used. The code chunk below is used to import *CoffeeChain.rds* into R.
...
The dataset contains different sales figures of coffee/tea products. The code chunk below is used to aggregate Sales and Budgeted Sales at the Product level.
...
the red color line represent the target, black is current, 2 grey shaded below is the 50%, and 75% of the target.
...
The code chunk used ggplot to draw a sparkline

-   min: red

-   max: blue

-   grey color bar represents 25 and 75 percentile.
...
static information dashboard by using [gt](https://gt.rstudio.com/) and [gtExtras](https://jthomasmock.github.io/gtExtras/) packages.

### **Plotting a simple bullet chart**

The code below using gt_plt_bullet to plot bullet chart report by using functions of gt and gtExtras packages.
...
we can create interactive information dashboard by using [reactable](https://glin.github.io/reactable/) and [reactablefmtr](https://kcuilla.github.io/reactablefmtr/) packages.
